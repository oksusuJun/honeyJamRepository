				...
				<tbody>
					<c:forEach items="${requestScope.reservation }" var="reservation">
						<tr>
							...
							<td style="width: 150px"><fmt:formatDate value="${reservation.checkIn}" pattern="yyyyMMdd" /></td>

							<td style="width: 150px"><fmt:formatDate value="${reservation.checkOut}" pattern="yyyyMMdd" /></td>
